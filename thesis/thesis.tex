...
\author{Conor Reid B.A, B.A.I, H.Dip}  % change to suit!
\date{}
...
%% Dedication
\chapter*{Dedication}
{To my family and friends who supported me throughout the last two years.}
...
{Thanks to Dr. James McDermott and Dr. Miguel Nicolau for first proposing this project, and for their subsequent guidance and support throughout the execution. They were always very generous with their time, for which I am very grateful. }

%% Abstract

%\begin{abstract}
\chapter{Abstract}
{Corporate governance models, styles and practices vary widely between companies and across regions. There is much debate on the influence of those differing models on company outcomes, as measured by various economic indicators. It is natural then to ask how one optimises corporate governance structures to best influence economic outcomes, and what best characterises those outcomes? \\\\
This project aims to address these questions, by first analysing the work of \cite{moldovan2015learning} and replicating their findings. We then extend those findings, by remodelling the problem and using auxiliary measures of corporate governance and company performance. Most importantly, we introduce modern methods of causal inference to this space in an effort to go beyond simple correlation towards the identification of stronger and more useful casual influences. \\\\
Using those correlations and {\it if-this-then-that} style rules proposed by \cite{moldovan2015learning}, we identify those that have causal merit as well as those that do not. Using the surrounding literature then, we compliment those findings with causal analysis in other areas to more holistically characterise the relationship between corporate governance and economic success.    
}
