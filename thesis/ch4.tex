...
{\bf Motivating Statement} & Statement \ref{spTwo} [agrees, original]  \\
{\bf Estimate ($\% \Delta , 95\% \ CI$)} &  (-0.15 , -0.12 , -0.09) \\~\\
{\bf Matching Plots} &
\end{tabular}
\begin{figure}[h!]
\begin{tabular}{ccc}
\subfigure[Asset]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/asset.png}} &
\subfigure[Cash Gen/Cash Reqd]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/Cash_gen_cash_reqd.png}} &
\subfigure[Dvd Yld]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/Dvd_Yld.png}} \\
\subfigure[Fin Lev]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/Fincl_l.png}} &
\subfigure[Net Debt/EBITDA]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/Net_dedt_to_ebitda.png}} &
\subfigure[OPM 12Mth]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/opm_t12m.png}} \\
\subfigure[P/B]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/P_B.png}} &
\subfigure[P/EBITDA]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/P_EBITDA.png}} &
\subfigure[Tax]{\includegraphics[width = 1.6in]{results/casual/indepDirFinlL/spx/altman/Tax.png}} \\
\end{tabular}
...
{\bf Motivating Statement} & Statement \ref{wildOne} [agrees, original] \\
{\bf Estimate ($\% \Delta , 95\% \ CI$)} &  (-0.11, -0.085, -0.06) \\~\\
{\bf Matching Plots} &
\end{tabular}
\begin{figure}[h!]
\begin{tabular}{ccc}
\subfigure[Assets]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/Asset.png}} &
\subfigure[EBITDA 12Mth]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/EV_EBITDA_T12M.png}} &
\subfigure[Fin Lev]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/Fincl.png}} \\
\subfigure[Net Debt/EBITDA]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/Net_Debt_to_EBITDA.png}} &
\subfigure[Norm NI to NI for Cmn]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/Norm_NI_to_NI_for_Cmn.png}} &
\subfigure[OPM 12Mth]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/OPM_T12M.png}} \\
\subfigure[P/B]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/P_B.png}}  &
%\subfigure[P/EBITDA]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/P_EBITDA.png}}  &
\subfigure[ROC]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/ROC.png}} &
\subfigure[\% Female Executives]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/tobin/X_Feml_Execs.png}}  
\end{tabular}
\caption{Causal Estimation - CEO Compensation}
\end{figure}
%\begin{figure}[h!]
%\begin{tabular}{ccc}
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/Asset.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/Cash_Gen_Cash_Reqd.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/Fincl.png}} \\
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/Net_Debt_to_EBITDA.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/Norm_NI_to_NI_for_Cmn.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/P_B.png}} \\
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/P_EBITDA.png}}  &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/CEOPayOverMedian/altman/ROC.png}}  &
...
\begin{figure}[h!]
\begin{tabular}{ccc}
\subfigure[Asset]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/Asset.png}} &
\subfigure[EBITDA 12Mth]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/EV_EBITDA_T12M.png}} &
\subfigure[Fin Lev]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/Fincl.png}} \\
\subfigure[OPM 12Mth]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/OPM_T12M.png}} &
\subfigure[P/B]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/P_B.png}} &
\subfigure[P/EBITDA]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/P_EBITDA.png}} \\
\subfigure[ROC]{\includegraphics[width = 1.6in]{results/casual/BOD_Age_Rng/spx/tobin/ROC.png}} 
\end{tabular}
\caption{Causal Estimation - Board of Directors Average Age}
\end{figure}
%\begin{figure}[h!]
%\begin{tabular}{ccc}
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/Asset.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/Cash_Gen_Cash_Reqd.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/Finc.png}} \\
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/Net_Debt_to_EBITDA.png}}&
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/P_EBITDA.png}} &
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/ROC.png}} \\
%\subfigure[caption]{\includegraphics[width = 1.5in]{results/casual/BOD_Age_Rng/altman/Tax.png}} 
%\end{tabular}
...
{\bf Motivating Statement} & Statement \ref{wildTwo} [agrees, NA ]  \\
{\bf Estimate ($\% \Delta , 95\% \ CI$)} &  (0.04 , 0.09 , 0.14) \\~\\
{\bf Matching Plots} &
\end{tabular}
\begin{figure}[h!]
\begin{tabular}{ccc}
\subfigure[Asset]{\includegraphics[width = 1.6in]{results/casual/socDis/spx/altman/asset.png}} &
\subfigure[Cash Gen/Cash Reqd]{\includegraphics[width = 1.6in]{results/casual/socDis/spx/altman/cash_gen_cash_reqd.png}} &
\subfigure[Interest]{\includegraphics[width = 1.6in]{results/casual/socDis/spx/altman/interest.png}} \\
\subfigure[Fin Lev]{\includegraphics[width = 1.6in]{results/casual/socDis/spx/altman/fincl.png}} &
\subfigure[Net Debt/EBITDA]{\includegraphics[width = 1.6in]{results/casual/socDis/spx/altman/net_debt_to_ebitda.png}} &
\subfigure[OPM 12Mth]{\includegraphics[width = 1.6in]{results/casual/socDis/spx/altman/opm_t12m.png}} \\
...
{\bf Motivating Statement} & Statements \ref{westTwo} [disagrees, original], \ref{spOne} [agrees, not original]  \\
...
{\bf Motivating Statement} & Statement \ref{westOne} [disagrees, original]  \\
...
{\bf Outcome} & Altman Z Score \\
{\bf Treatment} & \footnotesize{(Indep Lead Dir \& Financial Leverage $>$ 2.5)? 1 : 0 } \\
{\bf Motivating Statement} & Statement \ref{spTwo} [agrees, not original]  \\
...
{\bf Motivating Statement} & Statement \ref{eastThree} [agrees, original]  \\
